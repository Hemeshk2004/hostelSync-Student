...
class OthersStatusPage extends StatefulWidget {
  const OthersStatusPage({super.key});

  @override
  _OthersStatusPageState createState() => _OthersStatusPageState();
}

class _OthersStatusPageState extends State<OthersStatusPage> {
  String? userEmail;
