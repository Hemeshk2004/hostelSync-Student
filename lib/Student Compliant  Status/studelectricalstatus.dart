...
class ElectricalStatusPage extends StatefulWidget {
  const ElectricalStatusPage({super.key});

  @override
  _ElectricalStatusPageState createState() => _ElectricalStatusPageState();
}

class _ElectricalStatusPageState extends State<ElectricalStatusPage> {
  String? userEmail;
